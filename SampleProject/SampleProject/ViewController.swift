...
class ViewController: UIViewController {
    ...
    @IBAction func designSegmentControlChanged(_ sender: Any) {
        ...
        case 0:
            swiftyScrollableGraph.autoScroll = false
        ...
        case 1:
            ...
            swiftyScrollableGraph.pickedPoint.color = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            swiftyScrollableGraph.points.size = 7
            ...
            swiftyScrollableGraph.xAxisLine.size = 1
            swiftyScrollableGraph.xAxisLine.color = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)
            swiftyScrollableGraph.yAxisLine.isOn = true
            swiftyScrollableGraph.yAxisLine.size = 1
            swiftyScrollableGraph.yAxisLine.color = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)
            swiftyScrollableGraph.reloadGraph()
            
        case 2:
            swiftyScrollableGraph.autoScroll = false
            swiftyScrollableGraph.infoView = nil
            swiftyScrollableGraph.backgroundColor  = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)
            swiftyScrollableGraph.spaceBetweenPoints = 70
            swiftyScrollableGraph.animationTime = 1
            swiftyScrollableGraph.leftSpacer = 200
            swiftyScrollableGraph.rightSpacer = 200
            swiftyScrollableGraph.chartLine.color = #colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 1)
            swiftyScrollableGraph.chartLine.size = 3
            swiftyScrollableGraph.pickedPoint.size = 12
            swiftyScrollableGraph.pickedPoint.color = #colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1)
            swiftyScrollableGraph.points.size = 12
            swiftyScrollableGraph.points.color = #colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 1)
            swiftyScrollableGraph.xAxisLine.isOn = true
            swiftyScrollableGraph.xAxisLine.size = 1
            swiftyScrollableGraph.xAxisLine.color = #colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1)
            swiftyScrollableGraph.yAxisLine.isOn = true
            swiftyScrollableGraph.yAxisLine.size = 1
            swiftyScrollableGraph.yAxisLine.color = #colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1)
            swiftyScrollableGraph.reloadGraph()
        ...
        case 3:
            ...
            swiftyScrollableGraph.leftSpacer = 200
            swiftyScrollableGraph.rightSpacer = 200
            swiftyScrollableGraph.chartLine.color = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)
            swiftyScrollableGraph.chartLine.size = 1
            swiftyScrollableGraph.pickedPoint.size = 0
            swiftyScrollableGraph.pickedPoint.color = #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1)
            swiftyScrollableGraph.points.size = 0
            swiftyScrollableGraph.points.color = #colorLiteral(red: 0.1892094211, green: 0.1858699658, blue: 0.2130195114, alpha: 1)
            swiftyScrollableGraph.xAxisLine.isOn = true
            swiftyScrollableGraph.xAxisLine.size = 1
        ...
        case 4:
            ...
            swiftyScrollableGraph.leftSpacer = 200
            swiftyScrollableGraph.rightSpacer = 200
            swiftyScrollableGraph.chartLine.color = #colorLiteral(red: 0.9017687183, green: 0.9017687183, blue: 0.9017687183, alpha: 1)
            swiftyScrollableGraph.chartLine.size = 2
            swiftyScrollableGraph.pickedPoint.size = 14
    ...
    @IBAction func animateSliderChanged(_ sender: Any) {
        swiftyScrollableGraph.animates = !swiftyScrollableGraph.animates
        swiftyScrollableGraph.reloadGraph()
    }
    
    @IBAction func autoScrollSliderChanged(_ sender: Any) {
        swiftyScrollableGraph.autoScroll = !swiftyScrollableGraph.autoScroll
        swiftyScrollableGraph.reloadGraph()
    }
    
    @IBAction func showGridSliderChanged(_ sender: Any) {
        swiftyScrollableGraph.yAxisLine.isOn = !swiftyScrollableGraph.yAxisLine.isOn
        swiftyScrollableGraph.xAxisLine.isOn = !swiftyScrollableGraph.xAxisLine.isOn
        swiftyScrollableGraph.reloadGraph()
    }
