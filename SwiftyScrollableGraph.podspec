#
#  Be sure to run `pod spec lint SwiftyScrollableGraph.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  SwiftyScrollableGraph is easy to setup and use scrollable graph view for swift.
  ...
  s.source_files  = "SwiftyScrollableGraph", "SwiftyScrollableGraph/**/*.{h,m,swift}"
